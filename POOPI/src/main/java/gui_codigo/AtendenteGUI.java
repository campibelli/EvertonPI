...
public class AtendenteGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 250, 450, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtendenteGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
